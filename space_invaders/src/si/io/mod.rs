...
mod test {
    ...
    case(PORT2, Ev::Tilt, true, TILT_BIT, true),
    case(PORT2, Ev::Tilt, false, TILT_BIT, false),
    case(PORT1, Ev::P2Start, true, P2START_BIT, true),
    case(PORT1, Ev::P2Start, false, P2START_BIT, false),
    case(PORT1, Ev::P1Start, true, P1START_BIT, true),
    case(PORT1, Ev::P1Start, false, P1START_BIT, false),
    case(PORT1, Ev::P1Shoot, true, P1SHOOT_BIT, true),
    case(PORT1, Ev::P1Shoot, false, P1SHOOT_BIT, false),
    case(PORT1, Ev::P1Left, true, P1LEFT_BIT, true),
    case(PORT1, Ev::P1Left, false, P1LEFT_BIT, false),
    case(PORT1, Ev::P1Right, true, P1RIGHT_BIT, true),
    case(PORT1, Ev::P1Right, false, P1RIGHT_BIT, false),
    case(PORT2, Ev::P2Shoot, true, P2SHOOT_BIT, true),
    case(PORT2, Ev::P2Shoot, false, P2SHOOT_BIT, false),
    case(PORT2, Ev::P2Left, true, P2LEFT_BIT, true),
    case(PORT2, Ev::P2Left, false, P2LEFT_BIT, false),
    case(PORT2, Ev::P2Right, true, P2RIGHT_BIT, true),
    case(PORT2, Ev::P2Right, false, P2RIGHT_BIT, false),
    )]
